...
public class PostRepositoryCustomImpl implements PostRepositoryCustom {
	...
	@Override
	public Page<PostDto> findUnpublishedPosts(Pageable pageable, String filters) {
		...
		Long total = countUnpublishedPosts(filters);
	...
	private Long countUnpublishedPosts(String filters) {

		StringBuilder sql = new StringBuilder();

		sql.append("SELECT COUNT(*) FROM post WHERE post_nm_published = false ");
